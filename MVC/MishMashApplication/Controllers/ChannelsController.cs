namespace MishMashApplication.Controllers
{
    ...
    public class ChannelsController : BaseController
    {
        ...
        public IHttpResponse Details(int id)
        {
            ...
            if (channel is null) return MessageError("Unfound channel in database");
        ...
        public IHttpResponse Create()
        {
            if (!IsAdmin())
            {
                return this.MessageError($"Only Admins can add channels", "/Home/Index", "Home");
            }
            return View();
        }
        ...
        public IHttpResponse Create(ChannelDTO newChannel)
        {
            ...
            {
                return this.MessageError($"Channel with name {newChannel.Name} already exists", "/Home/Index", "Home");
            }
            ...
            Db.SaveChanges();
            return this.MessageSuccess($"Channel with name {newChannel.Name} was successfully added in Database", "/Home/Index", "Home");
        }
        ...
        public IHttpResponse MyChannels()
        {
            ...
            {
                return this.MessageError($"No logged user", "/Home/Index", "Home");
            }
        ...
        public IHttpResponse Unfollow(int id)
        {
            ...
            {
                return this.MessageError($"Channel not followed", "/Home/Index", "Home");
            }
        ...
        public IHttpResponse Follow(int id)
        {
            ...
            {
                return this.MessageError($"Non existin channel", "/Home/Index", "Home");
            }

            User foundUser = Db.Users.Include(x=>x.UserChannels).FirstOrDefault(x => x.Id == CurentUser.Id);
            if (foundUser.UserChannels.Any(x=>x.ChannelId==id))
            {
                return this.MessageError($"This channel is folowed already", "/Home/Index", "Home");
            }
